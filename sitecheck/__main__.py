...
from sitecheck.cli import display_check_result, read_user_cli_input
from sitecheck.checker import site_is_online, site_is_online_async

def main():
    """ Run Site Checker."""
    user_args = read_user_cli_input()
